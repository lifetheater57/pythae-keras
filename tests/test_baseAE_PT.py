...
from pythae.models import BaseAE_PT, BaseAE_PTConfig
...
@pytest.fixture(params=[BaseAE_PTConfig(), BaseAE_PTConfig(latent_dim=5)])
...
@pytest.fixture(
    params=[
        BaseAE_PTConfig(input_dim=(1, 28, 28), latent_dim=10),
        BaseAE_PTConfig(input_dim=(1, 100, 0), latent_dim=5),
        BaseAE_PTConfig(input_dim=(1, 1e4), latent_dim=5),
    ]
)
