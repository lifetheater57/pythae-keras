...
def sampler(model, sampler_config):
    return GaussianMixtureSampler(model=model, sampler_config=sampler_config)
...
class Test_GaussianMixtureSampler_saving:
    def test_save_config(self, tmpdir, sampler):
        ...
        generation_config_rec = GaussianMixtureSamplerConfig.from_json_file(
            sampler_config_file
        )
...
class Test_GaussianMixtureSampler_Sampling:
    ...
    def test_generation_pipeline(
        ...
        if sampler_config is None:
            ...
            assert isinstance(pipe.sampler, GaussianMixtureSampler)
